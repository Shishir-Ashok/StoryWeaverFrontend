...
export default function CreatePost({ initialData = null }) {
  const tagsList = [
    "Technology",
    "Science",
    "Business",
  ...
  console.log("CreatePost initialData: ", initialData);
  ...
  useEffect(() => {
    if (initialData) {
      ...
      setEditorContent(initialData.editor || null);
    }
  }, [initialData]);
  ...
  //TipTap Editor
  const editor = EditorInstance(editorContent);
